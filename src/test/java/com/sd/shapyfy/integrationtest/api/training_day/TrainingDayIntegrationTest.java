...
class TrainingDayIntegrationTest extends AbstractIntegrationTest {
    ...
    void getTrainingDay() {
        ...
        as(USER_WITH_ACTIVE_TRAINING.getTestUser()).assertRequest($ -> $
                ...
                .body("exercises[0].breakBetweenSets.minutes", is(1))
                .body("exercises[0].breakBetweenSets.seconds", is(0))
                .body("exercises[0].isFinished", is(false))
                ...
                .body("exercises[0].sets[0].isFinished", is(false))
                ...
                .body("exercises[0].sets[1].isFinished", is(false))
                ...
                .body("exercises[0].sets[2].isFinished", is(false))
                ...
                .body("exercises[1].breakBetweenSets.minutes", is(1))
                .body("exercises[1].breakBetweenSets.seconds", is(30))
                .body("exercises[1].isFinished", is(false))
                ...
                .body("exercises[1].sets[0].isFinished", is(false))
                ...
                .body("exercises[1].sets[1].isFinished", is(false))
                ...
                .body("exercises[1].sets[2].isFinished", is(false))
                ...
                .body("exercises[1].sets[3].isFinished", is(false))
                ...
                .body("exercises[2].breakBetweenSets.minutes", is(2))
                .body("exercises[2].breakBetweenSets.seconds", is(0))
                .body("exercises[2].isFinished", is(false))
                ...
                .body("exercises[2].sets[0].isFinished", is(false))
                ...
                .body("exercises[2].sets[1].isFinished", is(false))
                ...
                .body("exercises[2].sets[2].isFinished", is(false))
                ...
                .body("exercises[2].sets[3].isFinished", is(false))
    ...
    void runTrainingDayExercise() {
        as(USER_WITH_ACTIVE_TRAINING.getTestUser()).assertRequest($ -> $
                ...
                .body("breakBetweenSets.minutes", is(1))
                .body("breakBetweenSets.seconds", is(0))
                .body("isFinished", is(false))
                .body("sets[0].id", is("00000000-0000-0000-0002-020101010101"))
                .body("sets[0].reps", is(8))
                .body("sets[0].weight", is(40.0f))
                .body("sets[0].isFinished", is(false))
                ...
                .body("sets[1].isFinished", is(false))
                ...
                .body("sets[2].isFinished", is(false))
