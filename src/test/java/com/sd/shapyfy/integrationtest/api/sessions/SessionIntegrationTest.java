package com.sd.shapyfy.integrationtest.api.sessions;
...
//TODO IntegrationTest should be Isolated
class SessionIntegrationTest extends AbstractIntegrationTest {
    ...
    void getTrainingDay() {
        ...
        as(USER_WITH_ACTIVE_TRAINING.getTestUser()).assertRequest($ -> $
                ...
                .body("exercises[0].attributes.size()", is(1))
                //
                ...
                .body("exercises[0].sets[0].attributes.size()", is(1))
                //
                ...
                .body("exercises[0].sets[1].attributes.size()", is(1))
                //
                ...
                .body("exercises[0].sets[2].attributes.size()", is(1))
                //
                //
                ...
                .body("exercises[1].attributes.size()", is(1))
                //
                ...
                .body("exercises[1].sets[0].attributes.size()", is(1))
                //
                ...
                .body("exercises[1].sets[1].attributes.size()", is(1))
                //
                ...
                .body("exercises[1].sets[2].attributes.size()", is(1))
                //
                ...
                .body("exercises[1].sets[3].attributes.size()", is(1))
                //
                //
                ...
                .body("exercises[2].attributes.size()", is(1))
                //
                ...
                .body("exercises[2].sets[0].attributes.size()", is(1))
                //
                ...
                .body("exercises[2].sets[1].attributes.size()", is(1))
                //
                ...
                .body("exercises[2].sets[2].attributes.size()", is(1))
                //
                ...
                .body("exercises[2].sets[3].attributes.size()", is(1))
        ;
    }
    ...
    void runTrainingDayExercise() {
        as(USER_WITH_ACTIVE_TRAINING.getTestUser()).assertRequest($ -> $
                ...
                .body("sets[0].attributes.size()", is(1))
                //
                ...
                .body("sets[1].attributes.size()", is(1))
                //
                ...
                .body("sets[2].attributes.size()", is(1))
                //
    ...
    @Test
    @DisplayName("Trainee finish exercise EP[GET:/v1/sessions/{session_id}/part/{session_part_id}/exercise/{exercise_id}/completions]")
    void finishExercise() {
        as(USER_WITH_ACTIVE_TRAINING.getTestUser()).assertRequest($ -> $
                        .body("""
                                {
                                  "attributes": [
                                    {
                                      "id": "00000000-0000-0000-0002-020101010101",
                                      "value": "HIGH"
                                    }
                                  ],
                                  "sets": [
                                    {
                                      ...
                                      "attributes": [
                                        {
                                          "id": "00000000-0000-0000-0002-201010101011",
                                          "value": "3-5"
                                        }
                                      ]
                                    },
                                    {
                                      "id": "00000000-0000-0000-0002-020101010102",
                                      "reps": 7,
                                      "weight": 40,
                                      "attributes": [
                                        {
                                          "id": "00000000-0000-0000-0002-201010101021",
                                          "value": "0"
                                        }
                                      ]
                                    },
                                    {
                                      "id": "00000000-0000-0000-0002-020101010103",
                                      "reps": 5,
                                      "weight": 40,
                                      "attributes": [
                                        {
                                          "id": "00000000-0000-0000-0002-201010101031",
                                          "value": "0"
                                        }
                                      ]
                                    }
                                                       ...
                                                       """)
                        .patch("/v1/sessions/{session_id}/part/{session_part_id}/exercise/{exercise_id}/completions",
                                "00000000-0000-0000-0002-000000020101",
                                "00000000-0000-0000-0002-000002010101",
                                "00000000-0000-0000-0002-000201010101"))
                //
                .statusCode(200)
        ;
    }
